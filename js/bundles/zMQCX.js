...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "zMQCX", function() { return zMQCX; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace zMQCX.
 * @public
 */

goog.module('zMQCX.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param894 = function() {
    ie_open('article', null, null,
      ...
      ie_open('ul', null, null,
        ...
        var iconList912 = opt_data.page.icons;
        var iconListLen912 = iconList912.length;
        for (var iconIndex912 = 0; iconIndex912 < iconListLen912; iconIndex912++) {
          var iconData912 = iconList912[iconIndex912];
          ie_open('li');
            ie_open('svg', null, null,
                'class', 'lexicon-icon lexicon-icon-' + iconData912);
              ie_void('use', null, null,
                  'xlink:href', '/vendor/lexicon/icons.svg#' + iconData912);
            ie_close('svg');
            ie_open('span');
              var dyn8 = iconData912;
              if (typeof dyn8 == 'function') dyn8(); else if (dyn8 != null) itext(dyn8);
            ie_close('span');
          ie_close('li');
        }
    ...
    ie_open('article', null, null,
      ...
      ie_open('ul', null, null,
          'class', 'lexicon-icon-list list-unstyled');
        var flagList924 = opt_data.page.flags;
        var flagListLen924 = flagList924.length;
        for (var flagIndex924 = 0; flagIndex924 < flagListLen924; flagIndex924++) {
          var flagData924 = flagList924[flagIndex924];
          ie_open('li');
            ie_open('svg', null, null,
                'class', 'lexicon-icon lexicon-icon-' + flagData924);
              ie_void('use', null, null,
                  'xlink:href', '/vendor/lexicon/icons.svg#' + flagData924);
            ie_close('svg');
            ie_open('span');
              var dyn9 = opt_data.page.flagData[flagData924];
              if (typeof dyn9 == 'function') dyn9(); else if (dyn9 != null) itext(dyn9);
              itext(' (');
              var dyn10 = flagData924;
  ...
  $templateAlias1(soy.$$assignDefaults({content: param894}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'zMQCX.render';
}
...
class zMQCX extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(zMQCX, templates);
...
var zMQCX = function (_Component) {
  _inherits(zMQCX, _Component);

  function zMQCX() {
    _classCallCheck(this, zMQCX);

    return _possibleConstructorReturn(this, (zMQCX.__proto__ || Object.getPrototypeOf(zMQCX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(zMQCX, _iconsLexiconSoy2.default);

exports.default = zMQCX;
