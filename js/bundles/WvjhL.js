...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WvjhL", function() { return WvjhL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace WvjhL.
 * @public
 */

goog.module('WvjhL.incrementaldom');
  ...
  var param885 = function() {
    ie_open('article', null, null,
      ...
      ie_open('ul', null, null,
        ...
        var iconList903 = opt_data.page.icons;
        var iconListLen903 = iconList903.length;
        for (var iconIndex903 = 0; iconIndex903 < iconListLen903; iconIndex903++) {
          var iconData903 = iconList903[iconIndex903];
          ie_open('li');
            ie_open('svg', null, null,
                'class', 'lexicon-icon lexicon-icon-' + iconData903);
              ie_void('use', null, null,
                  'xlink:href', '/vendor/lexicon/icons.svg#' + iconData903);
            ie_close('svg');
            ie_open('span');
              var dyn8 = iconData903;
              if (typeof dyn8 == 'function') dyn8(); else if (dyn8 != null) itext(dyn8);
            ie_close('span');
          ie_close('li');
        }
    ...
    ie_open('article', null, null,
      ...
      ie_open('ul', null, null,
          'class', 'lexicon-icon-list list-unstyled');
        var flagList915 = opt_data.page.flags;
        var flagListLen915 = flagList915.length;
        for (var flagIndex915 = 0; flagIndex915 < flagListLen915; flagIndex915++) {
          var flagData915 = flagList915[flagIndex915];
          ie_open('li');
            ie_open('svg', null, null,
                'class', 'lexicon-icon lexicon-icon-' + flagData915);
              ie_void('use', null, null,
                  'xlink:href', '/vendor/lexicon/icons.svg#' + flagData915);
            ie_close('svg');
            ie_open('span');
              var dyn9 = opt_data.page.flagData[flagData915];
              if (typeof dyn9 == 'function') dyn9(); else if (dyn9 != null) itext(dyn9);
              itext(' (');
              var dyn10 = flagData915;
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'WvjhL.render';
}
...
class WvjhL extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(WvjhL, templates);
...
var WvjhL = function (_Component) {
  _inherits(WvjhL, _Component);

  function WvjhL() {
    _classCallCheck(this, WvjhL);

    return _possibleConstructorReturn(this, (WvjhL.__proto__ || Object.getPrototypeOf(WvjhL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WvjhL, _iconsLexiconSoy2.default);

exports.default = WvjhL;
