...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "YuXhx", function() { return YuXhx; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace YuXhx.
 * @public
 */

goog.module('YuXhx.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1428 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_open('table', null, null,
        ...
        ie_close('tbody');
      ie_close('table');
      $templateAlias2({code: '', mode: 'text/html'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'table-striped');
      ie_open('h3');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1428}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'YuXhx.render';
}
...
class YuXhx extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(YuXhx, templates);
...
var YuXhx = function (_Component) {
  _inherits(YuXhx, _Component);

  function YuXhx() {
    _classCallCheck(this, YuXhx);

    return _possibleConstructorReturn(this, (YuXhx.__proto__ || Object.getPrototypeOf(YuXhx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YuXhx, _tablesSoy2.default);

exports.default = YuXhx;
